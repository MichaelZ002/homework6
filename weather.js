// these variables are going to be used for a global use. So i can call and refer to them when needed.

var apiKey = "8ce74caf8f9fa27fa1199d79630b9a36";
var city = "chicago"
...
var indexone = "https://api.openweathermap.org/data/2.5/uvi?appid={appid}&lat={lat}&lon={lon}";
var searchArr = JSON.parse(localStorage.getItem("searchedItems")) || [];


//takes in the user inputs and passes the value into the variable
